...
# ============================================
# IMPORTANT - ဒီနေရာမှာ ခင်ဗျားရဲ့ တန်ဖိုးတွေထည့်ပါ
# ============================================
BOT_TOKEN = "8578788730:AAFz_DKpVifNKYyPIm48h8G3Pq-Ry-zGvOU"  # ခင်ဗျားရဲ့ Bot Token
BOT_NAME = getenv("BOT_NAME", "Umk")

API_ID = 25627383  # ခင်ဗျားရဲ့ API ID (ဂဏန်းပဲ)
API_HASH = "b5d81aa5417d7c326f8e91286c5556f4"  # ခင်ဗျားရဲ့ API Hash
